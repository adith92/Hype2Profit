...
Hype2Profit saat ini adalah prototype V1 untuk riset produk marketplace Indonesia.
...
- 🟡 Export job belum persisted
- 🔜 Social media internal search belum diimplementasikan
...
- Supabase migration untuk extension scan sessions
- Supabase migration untuk extension scan items
- Supabase migration untuk watchlist items
- Supabase migration untuk export jobs
- Update `/api/extension/ingest` agar validasi payload dan persist jika env tersedia
...
Priorities:
1. Finish v0.2.0 Core Persistence.
2. Add tests for scoring-engine and marketplace-adapters.

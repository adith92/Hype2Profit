...
> Baca file ini sebelum lanjut coding. Ini adalah papan kendali roadmap supaya Codex, ChatGPT, dan developer berikutnya tahu posisi terakhir proyek.
...
| API extension ingest | 🟡 IN_PROGRESS | Sudah menerima payload, belum persist ke database |
| Watchlist | 🟡 IN_PROGRESS | Masih prototype/in-memory |
| CSV export | 🟡 IN_PROGRESS | Prototype export job |
| Auth + per-user data | 🔜 PLANNED | Untuk v0.2.x |
...
### v0.1.1 - Project Memory Docs 🟡 IN_PROGRESS
...
- Developer baru bisa tahu apa yang sudah, sedang, dan belum dikerjakan.
- Codex bisa baca roadmap tanpa perlu konteks chat lama.

---

### v0.2.0 - Core Persistence 🔜 PLANNED
...
- 🔜 Persist export jobs
- 🔜 Validate payload `/api/extension/ingest`
...
- Tetap baca data yang terlihat di halaman user.
- Patuhi Terms of Service platform.
- Jangan tambahkan fitur pembelian otomatis atau pengumpulan data personal pembeli.
